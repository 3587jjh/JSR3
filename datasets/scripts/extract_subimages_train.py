...
def main():
    ...
    if mode == 'pair':
        # cut training data
        GT_folder = '/workspace/datasets/DIV2K_train_blurred_cropped/HR/x4'
        LR_folder = '/workspace/datasets/DIV2K_train_blurred_cropped/LR/x4'
        save_GT_folder = '/workspace/datasets/DIV2K_train_sub/HR/x4'
        save_LR_folder = '/workspace/datasets/DIV2K_train_sub/LR/x4'
        ...
        img_LR_list = dutils._get_paths_from_images(LR_folder)
        ...
        extract_signle(opt)
        assert len(dutils._get_paths_from_images(save_GT_folder)) == len(
            dutils._get_paths_from_images(
...
def extract_signle(opt):
    ...
    if not os.path.exists(save_folder):
        ...
        sys.exit(1)
    img_list = dutils._get_paths_from_images(input_folder)
