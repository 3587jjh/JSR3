...
save_list=["/workspace/datasets/DIV2K_valid_sub_class3/LR/x4",
           "/workspace/datasets/DIV2K_valid_sub_class2/LR/x4",
           "/workspace/datasets/DIV2K_valid_sub_class1/LR/x4",
           "/workspace/datasets/DIV2K_valid_sub_class3/HR/x4",
           "/workspace/datasets/DIV2K_valid_sub_class2/HR/x4",
           "/workspace/datasets/DIV2K_valid_sub_class1/HR/x4"]
for i in save_list:
    if os.path.exists(i):
        pass
    else:
