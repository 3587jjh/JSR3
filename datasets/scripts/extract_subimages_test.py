...
def main():
    ...
    if mode == 'pair':
        ...
        GT_folder = '/workspace/datasets/DIV2K_valid_HR_cropped/HR/x4/'
        LR_folder = '/workspace/datasets/DIV2K_valid_HR_cropped/LR/x4/'
        save_GT_folder = '/workspace/datasets/DIV2K_valid_sub/HR/x4'
        save_LR_folder = '/workspace/datasets/DIV2K_valid_sub/LR/x4'
